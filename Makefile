...
.PHONY: fresh_install
fresh_install: install_apt install_snap install_dotfiles install_wallpaper remap_caps  ## Complete fresh desktop install
...
install_dotfiles: clean_dotfiles  ## Install all dotfiles
